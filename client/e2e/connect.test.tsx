...
//       expect((await widget.findByTestId("connect-wallet")).textContent).toBe(
//         "Connect Wallet"
//       );
//     });
//   }
...
//       expect(
//         (await widget.findByTestId("account")).textContent?.toLowerCase()
//       ).toBe(HARDHAT_ACCOUNT_DISPLAY_STRING);
//     });
//   });
// });
